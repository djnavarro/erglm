...
wrappers around `glm()`, officially tested and supported for binomial,
poisson, gaussian, and Gamma families. For plotting exposure-response
models (including those fitted with erglm), see the companion package
...
VPC-style plot), see `erplots::er_vpc_plot()`.
